...
public class GravityBoard {
    GravityBall ball;
    GravityRocket rocket;
    int width, height;
    ...
    public GravityBoard(Pair<Integer, Integer> widthHeight, GravityBall ball, GravityRocket rocket) {
        this.ball = ball;
        this.rocket = rocket;
    ...
    public void handleBallRocketCollision() {
        if (checkRocketBallCollision()) {
            if (!this.hasCollision) {
                ball.handleRocketCollision(rocket.getTilt(), rocket.getZAcceleration());
    ...
    public void updateRocketVerticalAcceleration(float az) {
        rocket.updateRocketVerticalAcceleration(az);
    }
}
